...
zero = 0
for number in range (second_input, 0, -1):
  print("осталось секунд до взрыва", number)
  zero += 1
  answer_input = int(input("хотите обезвредить бомбу? "))
  if answer_input == 1:
    print("Бомба обезврежена, оставалось", number, "секунд")
    break
if zero == second_input:
