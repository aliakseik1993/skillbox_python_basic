...
if file_size <= 0 or speed <= 0:
  print("Неправильные входные данные, повторите попытку")
  file_size = int(input("Укажите размер файла для скачивания: "))
  speed = int(input("Какова скорость вашего соединения? "))
iterration = math.ceil(file_size / speed)
for sec in range (1, iterration + 1):
  if sec == iterration:
    print("Прошло", sec, "сек.", end = " ")
    print("Cкачано", file_size, "из", file_size, "Мб", "( 100% )")
    break
  print("Прошло", sec, "сек.", end = " ")
  print("Cкачано", speed * sec, "из", file_size, "Мб ", end = "")
  print("(", math.ceil(speed * sec / file_size * 100), "%)" )
print("Скачивание заняло,", iterration, "сек. или =", round(iterration / 60, 2), "минут")