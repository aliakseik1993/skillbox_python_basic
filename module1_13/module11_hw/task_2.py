...
import math
how_many = int(input("Введите кол-во чисел: "))
for number in range (how_many):
  number_input = float(input("Введите число: "))
  if number_input > 0:
    number_input = math.ceil(number_input)
    print("x = ", number_input, end = ", ")
    print ("log(x) =", math.log(number_input))
  else:
    number_input = math.floor(number_input)
    print("x = ", number_input, end = ", ")
    print ("exp(x) =", math.exp(number_input))