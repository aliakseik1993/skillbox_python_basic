...
hours_input = int(input("Введите отработанные часы: "))
money_credit_input = int(input("Введите остаток по кредиту: "))
expenses_foods = int(input("Введите траты на еду: "))
summ = int(200 * hours_input / 2 ** 3 + hours_input)
if summ >= money_credit_input + expenses_foods:
